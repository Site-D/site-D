...
<div id="barre">
	...
	<h1>Aide - 3DS/2DS &#x2794; Non hack</h1>

	<form method="post" action="aide-nonhack.php">
	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $stmt = $db->prepare('INSERT INTO messagesaide32dsnonhack (username, message) VALUES (:username, :message)');
	...
	$stmt = $db->query('SELECT * FROM messagesaide32dsnonhack ORDER BY id DESC');
