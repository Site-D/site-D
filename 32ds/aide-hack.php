...
<div id="barre">
	...
	<h1>Aide - 3DS/2DS &#x2794; Hack</h1>

	<form method="post" action="aide-hack.php">
	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $stmt = $db->prepare('INSERT INTO messagesaide32dshack (username, message) VALUES (:username, :message)');
	...
	$stmt = $db->query('SELECT * FROM messagesaide32dshack ORDER BY id DESC');
