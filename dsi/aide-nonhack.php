...
<div id="barre">
	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $stmt = $db->prepare('INSERT INTO messagesaidedsinonhack (username, message) VALUES (:username, :message)');
	...
	$stmt = $db->query('SELECT * FROM messagesaidedsinonhack ORDER BY id DESC');
