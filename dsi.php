...
<div id="barre">
	...
	<h1>Discussions - DSI</h1>

	<form method="post" action="dsi.php">
	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $stmt = $db->prepare('INSERT INTO messagesdsi (username, message) VALUES (:username, :message)');
	...
	$stmt = $db->query('SELECT * FROM messagesdsi ORDER BY id DESC');
