...
<div id="barre">
	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $stmt = $db->prepare('INSERT INTO messagesaidewiihack (username, message) VALUES (:username, :message)');
	...
	$stmt = $db->query('SELECT * FROM messagesaidewiihack ORDER BY id DESC');
