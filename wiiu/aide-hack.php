...
<div id="barre">
	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $stmt = $db->prepare('INSERT INTO messagesaidewiiuhack (username, message) VALUES (:username, :message)');
	...
	$stmt = $db->query('SELECT * FROM messagesaidewiiuhack ORDER BY id DESC');
