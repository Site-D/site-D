...
<div id="barre">
	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $stmt = $db->prepare('INSERT INTO messagesaidewiiu (username, message) VALUES (:username, :message)');
	...
	$stmt = $db->query('SELECT * FROM messagesaidewiiu ORDER BY id DESC');
