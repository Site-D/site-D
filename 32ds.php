...
<div id="barre">
	...
	<h1>Discussions - 3DS / 2DS</h1>

	<form method="post" action="32ds.php">
	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $stmt = $db->prepare('INSERT INTO messagesds (username, message) VALUES (:username, :message)');
	...
	$stmt = $db->query('SELECT * FROM messagesds ORDER BY id DESC');
